...
hl.curve("easy", { type = "spring", mass = 1, stiffness = 387.1191, dampening = 32.71279333 })
...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 10.4, spring = "easy", style = "popin 87%" })
